...
The below animated GIF doesn't capture the mouse pointer correctly, in real life the mouse pointer moves along with moving and resizing the window as it is supposed to. Nevertheless, it still shows the functionality of the tool.
